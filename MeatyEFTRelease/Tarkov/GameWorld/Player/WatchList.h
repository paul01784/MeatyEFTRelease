...
public:
    ...
    bool AddPlayer(Player& player, const std::string& reason);
    ...
    void UpdateWatchStatus(Player& player) const;
    ...
    bool logAddPlayer(Player& player);

    // Call this after profileId becomes available
    bool logUpdatePlayerPID(Player& player);
...
private:
    ...
    static bool IsEligiblePlayer(const Player& player);

    static std::string ResolveProfileId(const Player& player);

    static std::string ResolveAccountId(const Player& player);

    static std::string ResolvePlayerName(const Player& player);
