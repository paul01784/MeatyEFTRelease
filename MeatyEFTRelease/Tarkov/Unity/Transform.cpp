...
bool UnityTransform::TryResolveFromComponent(
    ...
    bool useCache)
{
    ...
    nativeTransform = mem.ReadChain(componentObject, TransformChain, ToCacheMode(useCache));
    return Memory::IsValidPointer(nativeTransform);
}
